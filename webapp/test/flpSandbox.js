		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsmoduxcontroldev-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmoduxcontroldev-display": {
								"semanticObject": "comsmoduxcontroldev",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smod.ux.controldev",
									"url": sap.ui.require.toUrl("com/smod/ux/controldev")
								}
							}
						}
					}
